...
export default function BentoGrid() {
  return (
    <div className="grid   grid-cols-1 md:grid-cols-8 md:grid-rows-8 w-full md:h-screen gap-2  text-white ">
      {/* bento Card 1 */}
      <div className="md:col-span-3 flex flex-col justify-end items-start gap-5   row-span-8 md:row-span-6 border border-lime-green/20 rounded-3xl py-5 px-3 relative  overflow-clip bg-[#D2FF8E]/6">
        ...
        <div className="headings">
          ...
          <div className="text-white/60">
            From navbars to dashboards, build what real devs face. Daily design
            problems, leaderboard pressure, and zero fluff.
          </div>
